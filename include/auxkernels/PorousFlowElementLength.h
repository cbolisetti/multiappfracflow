...
class PorousFlowElementLength;

template <>
InputParameters validParams<PorousFlowElementLength>();

/**
 * Computes a measure of element length.  A plane is constructed through the element's centroid, with normal equal to the direction given.  The average of the distance of the nodal positions to this plane is the 'length' returned.
 */
