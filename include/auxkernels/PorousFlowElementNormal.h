...
class PorousFlowElementNormal;

template <>
InputParameters validParams<PorousFlowElementNormal>();

/**
 * Computes a component of the normal of elements.  This is mostly designed for 2D elements.  1D and 3D elements are handled as special cases.
 */
