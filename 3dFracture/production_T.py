...
data = np.genfromtxt(r'matrix_app_out_fracture_app0_smalls.csv', delimiter=',', names=True)
plt.plot(data['time'][1:] / 3600.0 / 24.0, data['TK_out'][1:] - 273, label='Small heat transfer from matrix')
