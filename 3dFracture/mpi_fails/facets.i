...
[Mesh]
  [cluster34]
    ...
    # file = 'cornerFacets.exo'
    # file = 'intersectingCircleFacets.exo'
    file = 'tIntersectionFacets.exo'
  []
  [injection_node]
    type = BoundingBoxNodeSetGenerator
    input = cluster34
    bottom_left = '117 78 115'
    top_right = '120 81 118'
    new_boundary = injection_node
  []
  [production_node]
    type = BoundingBoxNodeSetGenerator
    input = injection_node
    bottom_left = '148 153 139'
    top_right = '151 156 142'
