...
[Mesh]
  [cluster34]
    ...
    file = 'intersectionRectangles.exo'
    # file = 'cornerRectangles.exo'
    #file = 'doubleRotateIntersectionRectangles.exo'
  []
  [injection_node]
    type = BoundingBoxNodeSetGenerator
    input = cluster34
    bottom_left = '-120 -120 0'
    top_right = '-80 -80 0'
...
[UserObjects]
  [dictator]
    ...
    porous_flow_vars = 'frac_T frac_P'
